...
cp -r "/content/drive/MyDrive/IDRiD_Datasets/Square_Format/labels/test/$lesion_type" "/content/square/labels/test/"
echo "Copying labels train..."
cp -r "/content/drive/MyDrive/IDRiD_Datasets/Square_Format/labels/train/$lesion_type" "/content/square/labels/train/"
echo "Copying labels val..."
cp -r "/content/drive/MyDrive/IDRiD_Datasets/Square_Format/labels/val/$lesion_type" "/content/square/labels/val/"
# copy the full size image data from the Google Drive to the local directory
echo "Copying images..."
echo "Copying images test..."
cp -r "/content/drive/MyDrive/IDRiD_Datasets/Square_Format/$image_type/test" "/content/square/$image_type/"
echo "Copying images train..."
cp -r "/content/drive/MyDrive/IDRiD_Datasets/Square_Format/$image_type/train" "/content/square/$image_type/"
echo "Copying images val..."
cp -r "/content/drive/MyDrive/IDRiD_Datasets/Square_Format/$image_type/val" "/content/square/$image_type/"
